...
7. Data is persisted under `data/sites` and `data/logs` in the version directory.
...
> Redis logical databases default to 10/11. Change them during installation if those DB numbers are already used by another application.
